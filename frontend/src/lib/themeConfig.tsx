...
// ============================================================================
// PRE-CALCULATED POSITIONS (generated once at module load)
// ============================================================================
...
const MAGIC_STARS = generateMagicStars();
const SPACE_STARS = generateSpaceStars();
...
const ExplorersBackground = memo(() => (
  <>
